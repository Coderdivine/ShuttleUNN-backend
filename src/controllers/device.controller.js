...
class UserContoller {
    ...
    async getBatteryLevel(req, res) {
        try {
            ...
            const result = await DeviceService.getBatteryLevel({ devsensor_id, battery_level });
    ...
    async getBatteryHealth(req, res) {
        try {
            ...
            const result = await DeviceService.getBatteryHealth({ devsensor_id, battery_health });
    ...
    async getDevicehealth(req, res) {
        try {
            ...
            const result = await DeviceService.getDevicehealth({ devsensor_id, device_health });
    ...
    async getDeviceMemory(req, res) {
        try {
            ...
            const result = await DeviceService.getDeviceMemory({ devsensor_id, device_memory });
    ...
    async getDeviceAge(req, res) {
        try {
            ...
            const result = await DeviceService.getDeviceAge({ devsensor_id, device_age });
    ...
    async trackFrequency(req, res) {
        try {
            ...
            const result = await DeviceService.trackFrequency({ devsensor_id, frequency });
